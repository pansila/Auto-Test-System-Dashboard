<template>
  <div class="app-container">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleRegister">Create An Account</el-button>

      <el-row type="flex" justify="end">
        <el-col :span="12">
          <el-button type="text" style="width: 100%" @click="gotoLogin">Already have an account? Login</el-button>
        </el-col>
      </el-row>
