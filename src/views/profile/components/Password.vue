<template>
  <el-form :model="form" :rules="passwordRules">
    <el-form-item :label="$t('profile.origPassword')" prop="oldPassword">
      <el-input v-model="form.oldPassword" type="password" />
    </el-form-item>
    <el-form-item :label="$t('profile.newPassword')" prop="newPassword1">
      <el-input v-model="form.newPassword1" type="password" />
    </el-form-item>
    <el-form-item :label="$t('login.confirmPassword')" prop="newPassword2">
